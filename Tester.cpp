...
int main()
{
	...
	*/
	...
	string filename = "images/testImage4.PNG";
	...
	else
	{
		...
		source.SaveImage("images/testImage4out.tga");
		Algorithm2 a2(source);
		a2.Run("text/algorthim2test4.txt");
		...
		error = lodepng::encode(filename, colors, width, height); //ERROR WAS HERE. SAID ENCODE WAS NOT RECOGNISED
		if(error)
		{
